...
<img src="{{ site.baseurl }}/assets/images/steel-test-upright.jpg" alt="Experimental Upright" style="width:100%">
...
<img src="{{ site.baseurl }}/assets/images/angle_vs_rad.jpg" alt="Plot of Steer Angle vs. Turn Radius" style="width:49%;padding-right:15px">
<img src="{{ site.baseurl }}/assets/images/ack_vs_rad.jpg" alt="Plot of Ackermann Percentage vs. Turn Radius" style="width:49%;padding-left:15px">
